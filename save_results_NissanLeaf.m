...
% 'results_NissanLeaf/FTP75' created by the script, in the csv files
...
mkdir results_NissanLeaf/FTP75/;
save('results_NissanLeaf/FTP75/I_cell.txt','Battery_I_cell','-ascii');
...
csvwrite('results_NissanLeaf/FTP75/dataset_Pwr.csv',dataset_all_Pwr);
csvwrite('results_NissanLeaf/FTP75/dataset_Enrg.csv',dataset_all_Enrg);
